...
const inputStyle = { width: "100%", padding: "11px 14px", borderRadius: 12, border: "1px solid #ece8f5", background: "#fafaf8", fontSize: 14, color: "#1a1a2e", outline: "none", boxSizing: "border-box" };
    ...
    <div style={{ minHeight: "100vh", background: "#fafaf8", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, ease }} style={{ width: "100%", maxWidth: 420 }}>
        <Link to="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 10, justifyContent: "center", marginBottom: 32 }}>
          <div style={{ width: 36, height: 36, borderRadius: 10, background: "linear-gradient(135deg,#6b5cf6,#a78bfa)", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 24, padding: 32, border: "1px solid #ece8f5", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
          <h1 style={{ fontSize: 22, fontWeight: 800, color: "#1a1a2e", margin: "0 0 6px", letterSpacing: "-0.02em" }}>Create account</h1>
          <p style={{ fontSize: 14, color: "#9b8fb5", margin: "0 0 24px" }}>Start your interview prep journey</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {[{ label: "Full Name", key: "name", type: "text", placeholder: "Nikita Sharma" }, { label: "Email", key: "email", type: "email", placeholder: "you@example.com" }, { label: "Password", key: "password", type: "password", placeholder: "Min 6 characters" }].map((f) => (
              <div key={f.key}>
          ...
          <p style={{ textAlign: "center", fontSize: 13.5, color: "#9b8fb5", marginTop: 20, marginBottom: 0 }}>
            Already have an account? <Link to="/login" style={{ color: "#6b5cf6", fontWeight: 600, textDecoration: "none" }}>Sign in</Link>
          </p>
        </div>
      </motion.div>
    </div>
