...
function StatCard({ card, index }) {
  return (
    ...
    >
      ...
      <div className="text-[1.9rem] font-extrabold text-ink tracking-tight leading-none">
        {card.value}
      </div>
...
export default function Dashboard() {
  ...
  const activities = (progress?.activities || []).map((a) => ({
    text: a.text,
    time: a.time,
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              <div className="min-w-0">
                <h1 className="text-lg sm:text-xl font-bold text-ink tracking-tight m-0 truncate">
                  Dashboard
                </h1>
            ...
            <div className="hidden sm:flex items-center gap-3 shrink-0">
              ...
              <Link
                to="/profile"
                className="w-9 h-9 rounded-[10px] bg-gradient-brand-soft flex items-center justify-center text-[13px] font-bold text-white hover:opacity-90 transition-opacity"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            >
              <div className="flex items-center justify-between mb-5">
                ...
                <Link
                  to="/result"
                  className="text-xs text-brand font-semibold no-underline hover:opacity-80"
                >
                  View all →
                </Link>
              </div>
              <div className="flex flex-col gap-3">
                {activities.length === 0 ? (
                  ...
                  >
                    <div
                      className="w-[34px] h-[34px] rounded-[10px] shrink-0 flex items-center justify-center text-[10px] font-bold"
            ...
            >
              <div className="flex items-center justify-between mb-5">
                ...
                <span className="text-[11px] font-bold px-2.5 py-1 rounded-full bg-green-50 text-green-600">
                  🔥 14-day streak
                </span>
              </div>
                ...
                {goals.map((g, i) => (
                  <div key={g.label}>
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-[13px] font-bold" style={{ color: g.accent }}>
                        {g.progress}/100
                      </span>
                    </div>
                    <div
